...
//
//@MainActor
//public struct TextViewFilterApplier<Interface: TextSystemInterface> {
//    public let filters: [any NewFilter]
//	public let providers: WhitespaceProviders
//
//	public init(filters: [any NewFilter], providers: WhitespaceProviders) {
//        self.filters = filters
//		self.providers = providers
//    }
//
//	private func shouldApplyMutation(_ mutation: NewTextMutation<Interface>, to textView: TextView) -> Bool {
